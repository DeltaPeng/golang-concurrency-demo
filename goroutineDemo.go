...
func main() {
	...
	// use make() to create a channel for communication between Goroutines (aka the bg jobs/threads)
    ...
    // add to number of goroutines that the waitgroup should wait for. Add before kicking off the goroutine.
    // in this case, add 2 since we're about to run 2 goroutines
    // if try to view variable get something odd like &{{} {{} {} 4294967297} 0}
    wg.Add(2)
